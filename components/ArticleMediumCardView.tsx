  ...
  return (
    ...
    <div className="col-span-8 flex flex-col">
      <Link href={article?.link} target="_blank">
        <div
          className="font-bold text-lg pt-1 lg:pt-2 lg:text-2 line-clamp-2 lg:line-clamp-2">
          {article.title}
        </div>
        <div
          className="font-light text-sm lg:text-lg pt-2 line-clamp-2 lg:line-clamp-2">
          {description}
        </div>
      </Link>
    </div>
